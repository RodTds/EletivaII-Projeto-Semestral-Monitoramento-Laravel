                        ...
                        <tbody>
                            @foreach ($radios as $radio)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-success" onclick="abrirModalEdicao({{ $radio->id }})">Editar</button>
                                        <button class="btn btn-sm btn-danger" onclick="abrirModalExcluir({{ $radio->id }})">Excluir</button>
                                    </td>
                                </tr>
                            @endforeach
                            @if(count($radios) === 0)
                ...
                <form method="post" action="/radio">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="ip" name="ip" class="form-control form-control-sm" required>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="ssid" name="ssid" class="form-control form-control-sm" required>
                        </div>
                        <div class="col-md-6">
                            <label for="direcao" class="form-label">Direção</label>
                            <input type="text" id="direcao" name="direcao" class="form-control form-control-sm" required>
                        </div>
                        <div class="col-md-6">
                            <label for="frequencia" class="form-label">Frequência</label>
                            <input type="text" id="frequencia" name="frequencia" class="form-control form-control-sm" required>
                        </div>
                        <div class="col-md-6">
                            <label for="canal" class="form-label">Canal</label>
                            <input type="text" id="canal" name="canal" class="form-control form-control-sm" required>
                        </div>
                        <div class="col-md-6">
                            <label for="senhawifi" class="form-label">Senha Wifi</label>
                            <input type="password" id="senhawifi" name="senhawifi" class="form-control form-control-sm" required>
                        </div>
                        <div class="col-md-6">
                            <label for="login" class="form-label">Login</label>
                            <input type="text" id="login" name="login" class="form-control form-control-sm" required>
                        </div>
                        <div class="col-md-6">
                            <label for="senhaacesso" class="form-label">Senha Acesso</label>
                            <input type="password" id="senhaacesso" name="senhaacesso" class="form-control form-control-sm" required>
                        </div>
                        <div class="col-md-12">
